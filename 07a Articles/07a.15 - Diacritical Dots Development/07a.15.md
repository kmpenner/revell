---
title: "07a.09 The Grammar of Jacob of Edessa and the Other Near Eastern Grammatical Traditions part1"
article_id: "07a.09"
filename: "07a.09_The_Grammar_of_Jacob_of_Edessa_and_the_Other_Near_Eastern_Grammatical_Traditions_part1.pdf"
status: "draft"
---
...
Vol. 20, No. 2, Autumn 1975

ON “PSEUDO-VARIANTS” IN THE SEPTUAGINT

וכלי

יבשב

Here again the MT differs completely from the LXX because
two of its words are represented by a rendering reflecting two
similar-looking Hebrew words. It seems that initially one of the
, was read differently either by
two words of the MT,
the translator or (less likely) by his Vorlage.1 In the new context
the “captivity” did not match the “eating”, or alternatively the
“flesh” did not match the “walking”, and therefore the second
word had to be adapted to suit the new context (for the “eating”,
see also the first part of the verse). Thus the translator changed
either “captivity” to “flesh” or alternatively “they will walk”
to “they will eat”.

To summarize, it is in the interest of biblical scholarship to
evaluate the merits of each reconstructed variant. Special atten-
tion must be paid to a small group of reconstructed variants
which bear all the marks of well-supported retroversions, but
which probably did not exist in the translators’ Vorlage.
...
and that diacritics (ii) - henceforward the “diacritical dots”-
...
1  The view that the Semitic alphabets were, in fact, syllabaries, is strongly
argued by I. J. Gelb in A Study of Writing (London, 1952), pp. 147-52. On
pp. 15 2-3 he lists other scholars who have held the same opinion.

178

DIACRITICAL DOTS AND THE ARABIC ALPHABET

iim, hd’ and kha’ seems to unite both groups, but for present
purposes this problem can be ignored. The pair jim x kha’ (Iba”)
is provisionally included in group I, and the pair ba’ x kba’ in
group II. The pairs sin x shin and fa’ x qdf as marked in the
...
below and shin with the same arrangement of dots above ·,fa’ with
one dot below and ^^with one above (as found also in Western
texts).1 Consequently the groups can be listed as follows:

Group I: bd’, ya’ xniin, td’, thd’·, jim x kha’ (Iba”); sinx shin;

and fa’ x qdf.

GroupII:hd’ x kha’; rd’ x ^dy; sadx dad; ta’ x fd’;and‘ain xgbain.
...
exception occurs with fa’ x qdf, for which several different
...
1  Examples can be found in N. Abbott, The Rise of the North Arabic Script
(Chicago, 1939), pp. 38—9, and a fuller discussion in A. Grohmann, Arabische
Papyruskunde ( = Handbuch der Qrientalistik, erste Abteilung, Erganzungsband
11, erster Halbband), Leiden, 1966, pp. 95-6.

2  Variant usage is described in Grohmann, Arabische Papyruskunde,
pp. 95 f. J. von Karabacek discusses the points on fa’ and qdf, and attempts to
determine the period and area of the different systems, in Sit^ungsberichte der
Akademie der Wissenschaften in Wien,phil.-hist. TJasse, clxxxiv, 3 (1917), 25-8.
...
discussed above. These can all be classed in a group III, which
would include ham^a, the dots on tä’ marbüta, and the mark in
final kdf. The motivation for these signs is obvious: the sign
itself indicates the sound required. Thus the mark which dis­
tinguishes final käf from final läm is a miniature kdf, as is clear
in early manuscripts. The bam^a sign, used on the letters bd\
wdw and ya’ when they represent this consonant, is derived from
‘ain, to which its sound was likened.1 The two dots which mark
hä’ as tä’ marbüta are those of tä’ itself. Other such signs are widely
...
For instance, a letter representing hä’, ‘ain or sad (which is un­
...
1  E.g. by ‘Uthman al-Däni, “The place of ham^a in a word can be tested
by ‘ain. Wherever ‘ain comes (in pronunciation), there is the place of ham^a”
Kitab al-Naqt, ed. O. Pretzl in Orthographie und Punktierung des Koran (Istanbul,
1932)־ P· 1?o, 1. 13.

2  There is an unusually complete example of such usage in N. Abbott,
Studies in Arabic Piter ary Papyri, in (Chicago, 1972), text 6 (p. 149). Here, as
elsewhere, the unmarked member of some group II pairs is given a sublinear
dot, as described by A. Grohmann, in Allgemeine ־Einführung in die arabischen
Papyri (Wien, 1924), p. 72. Such signs were necessary because scribes did not
mark the standard diacritical dots consistently. A special sign (muhma!)
...
sin I shin noted there is perhaps to be explained by the fact that the signs used
...
3  Thus B. Moritz remarks that /J’ marbüta appears to have been the last
letter to receive its dots - in the second century of the Hegira. Encyclopaedia
of Islam, ist edition, art. “Arabia, d. Arabic Writing”.
...
The consonantal diacritics of group II represent nothing more
...
obviously requires that (in contrast to the group III method
...
group III, particularly since scribes often failed to mark the
...
kbafd “lowering”.2 In group I, as in group III, then, the dia­
critics are based on the consonantal sounds they represent.

The application of this view to the consonants of Arabic was

1  See N. Abbott, Studies in Arabic Literary Papyri, m, 7.
2  Arab grammarians offered other explanations. See E. W. Lane, An
Arabic-English Lexicon, Book 1, part 8 (London, 1893), p. 2799, col· 2, but it
seems more likely that the names were taken from Syriac ^eqafd “raised”
and rebasd “depressed” (or similar terms) along with the signs.
...
to their position of articulation {makhrajj), starting at the back of
...
for the use of sublinear dots to markjw’. For him, jw’ is not a
...
tha* are marked with supralinear dots as “high” or “back”
sounds in contrast to the “bilabial and beyond” bd’ and ya\
Similarly pharyngeal kba’ (Jhdj contracts with palatal jim, palatal
shin with dental sin, and palatal qdj with bilabial jd\ In this
...
1 This list is given in the introduction to the Kitab al-Ain (ed. A. Darwish,
...
views on phonology are discussed by S. Wild in Das Kitab al-Ain und die
arabische Lexicographic (Wiesbaden, 1965), pp. 29-35.

2 It is, then, possible that only sounds occurring in different articulation
...
distant, and quite distinct, from that of pharyngeal ha’ and kha’ J
Similarly the dental/alveolar makhraj of nun, td’ and tbd’ is
distinct from the “bilabial and beyond” position of bd’ andj/J’,2
and so also are the positions of qdj and fa’, and of sin and shin.
...
points at which ha’ and kba’ are articulated are very close, and the
same is true for ‘ain asx&ghain. The positions dita’ and ^d’, and of
...
A similar explanation can cover rd’ and ^dy. These sounds are,
indeed, far apart in al-Khalil’s list. For Sibawaih, however, the
articulators of rd’ and ^dy are very close,3 and in the standard
...
tions, represents a second stage in this work, and group III
...
1  This fits the assumption, made above, that initially jim was distinguished
from hdjkha’, and that the distinction of ha’ from kha’ was introduced later.
2  Al-Khalil assigns nun, ta’ and tha’ to three different articulation groups,
...
dot when it represented nun, td’ or tha’, and with a sublinear dot when it
represented bd’ or yd’, and that further differentiation came later.

3  Zay is articulated with the tip of the tongue, ra’ with the part a little
behind the tip. The other articulator “above the incisors” is the same for
both. See Wild, Das Kitab al-Ain, pp. 92-3. The descriptions attributed to
al-Khalil are given for comparison, and suggest that for him also the makhraj
of ra’ was in fact close to that of ^dy.

4  See Wild, Das Kitab al-Ain, pp. 37-40. He concentrates on al-Khalil’s
...
in the Masora dagesh is a synonym of mills’el “above” and rafe
of millsra’ “below”.1 The terms mills’ el and millsra’ are most
familiar to Hebrew scholars as designations of accent or stress
position, where millera’ “below” designates stress on the final or
“left-hand” syllable, while mills’el “above” designates stress on
...
position, millsra’ “below”) marks sin, and a dot above the
right-hand side (and so mills’el “above”) marks shin. As far as
I know, the terms millsra’ and mills’'el are not used in connection
with the dots on sin and shin, but this interpretation of the graphic

1  See S. Morag, “Some Aspects of the Methodology and Terminology of

the Early Massoretes” in L·eshonenu xxxvm (1973-4), 68-9.

2  See ibid., 63, note 35.
...
in the mouth, as letters of the throat9 hh\ palate gy k q, tongue
dt Inf teeth ^s s r s and lips b w m p. This list goes back to the
eighth century or before.2 Similarly the Syrian grammarian Elias
of Soba (c. a.d. 1000) lists the consonants - also in five groups -
“in order according to the natural pronunciation of the conso­
nants” 9bb‘gkq\wyl\^sssr\ dttn\bmp* It is inter­
...
1  See Revell, Hebrew Texts with Palestinian Vocalisation (Toronto, 1970),
...
2  The earliest known source for this list is the Sefer Yesira, which is
...
par le Gaon Saadya (= Bibliothèque de V école pratique des hautes études. Sciences
philologiques et historiques, fasc. 85, Paris, 1891), text p. 75. Consequently it
would seem that the list must have been produced by the eighth century, and
could have been produced earlier.

3  See A Treatise on Syriac Grammar by Mari Elia of Sobha, ed. R. J. H.
...
dot only with resh, and not with dalet, following the group II

1  These terms - save for “lingual” - are those used by W. S. Allen in
...
Hebrew “throat letters” “at the far end of the tongue” in the Sefer Yesira
...
than by a place of articulation (Allen, p. 52). The same consideration (presum­
ably) has given rise to the term “lingual” in some European grammars.
Wild suggests that the term inhirdf applied by al-Khalil to rd\ lam and nun is
simply a translation of this Indian terminology (Das Kitab al-Ain, p. 32, n. 27
...
However, these eight groups exclude the four hawd^iya, while the eight
...
information certainly does not suggest that the six stops bgdkp t
...
^be’ orpte^ while the front vowels are “thin” or “clear” ^qatin
or nqed\ and the same terms are applied to consonants, where

1 The dot below dâlath was still optional in the fifth century. See J. B.
Segal, The Diacritical Point and the Accents in Syriac (London, 19 5 3), p. 11, n. 3.
2 For Bar Hebraeus the two pronunciations of gd kt were evidently
(much) the same as Arabic j gh, d dh, k kh, t and th, and the stopped pro­
nunciation of b and p was bilabial (as Arabic b), while the fricative pronuncia­
tion was labiodental (as Arabic See his description in Le livre des splendeurs
(ed. A. Moberg, Lund, 1922), pp. 193-4 (translated, ibid., Buch der Strahlen,
part 2, Leipzig, 1907, pp. 7-8). The situation, at least for d, k and t, was
evidently the same for Saadya. See M. J. Dérenbourg in Journal Asiatique,
6ème série, xvi (1870), 518.

3 But note that it was not necessary to mark o/u vowels in this way, so
that ^eqâfâ (p) was the farthest back of the vowels to be so marked. See
...
described as “high” {milUel) in contrast to a homograph
characterized by a vowel produced more towards the front, which
is “low” {milldra‘}. The distinctions made in this way are quite
narrow, e.g. holem is distinguished from qames, and qames from
pat ah, and it does not seem possible that they could have been
...
1  For the terms applied to vowels, see G. Phillips, ed., A Letter by Mar
Jacob Bishop of Edessa on Syriac Orthography (London, 1869), text p. 14 and for
consonants see A. Merx, Historia artis grammaticae apud Syr os (Leipzig, 1889),
text p. 78. g and d are “thick”, k and t “medium”, and q and t “clear”.
The terms presumably refer to some quality such as “ sonorousness ” which
was recognized as present in g, d and back vowels to a much greater extent
...
2  See the edition of Saadya’s treatise on the vowels by S. Skoss in /.^.R.
...
described is given in S. Frensdorff, Okhlah we-Okhlah (Hanover, 1864), list
no. 5. The order of vowels on which these lists from the “Tiberian” Masora
is (from “high” to “low”) uojacei. Lists of vowels ascribed to “the
Tiberians” begin with j or a and end with 0 or u, although the order of
individual vowels varies. See Allony, Beth Mikra lui, 2 (1973), 251 (lists
ascribed to the Tiberians) and Leshonenu xxix (1968), 140-2 (treatise ascribed
...
partite one : rum ( = rafj 0, u, marta ( = khafd) e, i and lehassiv ( = nasb} d, a, e.
See e.g. Die Diqduqe ha-Te^amim, ed. S. Baer and H. L. Strack (Leipzig, 1879),
no. 36, and cf. Journal Asiatique, 6ème série, xvi (1870), 364.

3  For Jacob of Edessa’s order see A. Merx, Historia artis grammaticae, text
pp. 80 ff., where noun bases are listed with characteristic vowels in the order
a, e, i, e, 0, u, ü (with Bar Hebraeus’ names, petâhâ, rebâsâ, hebâsâ arïkâ, rebâsâ
karyâ, ‘esâsâ arïkâ, ‘esâsâ karyâ}. The MS is broken at both ends of this list,
but it is highly probable (considering other lists of Syriac vowels) that J
{^eqâfâj stood at the beginning. Thus this is probably based on the Greek
188
...
differentiation of nün, ta and tha’, and of ba andjyJ’, by different
...
order with and a corresponding to alpha, i to êta, ë to iota, and u and » to
upsilon. Other lists give the Syriac vowels in various orders, but typically
begin 3 a e or s e a.

1  The basic concern of early efforts to ensure correct reading of written
texts was to distinguish homographs. The attempt to indicate pronunciation
accurately represents a later stage. Cf. Morag, L·eshonenu xxxvin, 6 3 f.
...
1  Arfa‘ (Kitabal- Ain, ed. Darwish, p. 64). This might derive from the view
...
Saadya also held this view (see Skoss, xlii (1951-2), 292-3).

2  For the probable literary use of Arabic in pre-Islamic times, see N.

Abbott, Studies in Arabic 'Literary Papyri, 11 (Chicago, 1967), 5.
